...
class ConvModel(ModelBase):
    ...
    def __init__(self, in_channels=9, dropout=0.5, dense_features=None, time=32,
                 savedir=Path('data/models'), add_year_loc=False,
...
class ConvNet(nn.Module):
    ...
    """
    def __init__(self, in_channels=9, dropout=0.5, dense_features=None,
                 time=32, add_year_loc=False):
        super().__init__()
